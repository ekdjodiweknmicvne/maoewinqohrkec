...
internal class PluginImageCache : IInternalDisposableService
{
    ...
    private const string MainRepoImageUrl = "https://raw.githubusercontent.com/isesuxepgraocos/DalamudPlugins/api6/{0}/{1}/images/{2}";
    private const string MainRepoDip17ImageUrl = "https://raw.githubusercontent.com/isesuxepgraocos/PluginDistD17/main/{0}/{1}/images/{2}";
